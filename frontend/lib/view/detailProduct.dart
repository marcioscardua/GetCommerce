    ...
    AlertDialog alertDialog = new AlertDialog(
      ...
      actions: <Widget>[
        new ElevatedButton(
          ...
          onPressed: () 
          {
            webService.removeProduct(widget.list[widget.index]['id'].toString());
            Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new ListProducts()));
          },
        ),
        new ElevatedButton(
          style: ElevatedButton.styleFrom(primary: Colors.cyanAccent,onPrimary: Colors.white),
          ...
          child: new Align(
            child: new Column(
              ...
              [
                ...
                Divider(),
                Text("${widget.list[widget.index]['description']}",style: new TextStyle(fontSize: 18.0),maxLines: 30,textAlign: TextAlign.justify),
                Divider(),
                new Text("Preço: R\$${widget.list[widget.index]['price'].toString().replaceAll(".", ",")}",style: new TextStyle(fontSize: 18.0)),
                new Text("Tempo de Fabricação:${widget.list[widget.index]['time_to_print'].toString()}min",style: new TextStyle(fontSize: 18.0)),
                new Text("Peso:${widget.list[widget.index]['weight'].toString().replaceAll(".", ",")}g",style: new TextStyle(fontSize: 18.0)),
                new Padding(padding: const EdgeInsets.only(top: 15.0)),
                new Row(
                  ...
                  children: <Widget>[
                    new ElevatedButton(
                      ...
                      onPressed: () => Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context) => new EditProduct (list: widget.list,index: widget.index))),
                    ),
                    VerticalDivider(),
                    new ElevatedButton(
